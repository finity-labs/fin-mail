    ...
    */
    ...
    'compose' => [
        ...
        'confirm' => [
            ...
            'description_multiple' => 'لديك عدة مستلمين. اختر كيف تريد إرسال هذا البريد الإلكتروني.',
            'send_mode_label' => 'كيف تريد الإرسال؟',
            'send_mode_individual' => 'إرسال كل بريد على حدة',
            'send_mode_individual_help' => 'يتم إرسال بريد منفصل إلى كل مستلم في حقل "إلى"، بحيث لا يرى أي منهم عناوين الآخرين. تتلقى جهات CC/BCC نسخة من كل بريد.',
            'send_mode_combined' => 'إرسال بريد واحد إلى عدة مستلمين',
            'send_mode_combined_help' => 'يتم إرسال بريد واحد إلى الجميع. تظهر جميع عناوين "إلى" وCC لكل مستلم.',
        ],
