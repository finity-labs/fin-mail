    ...
    */
    ...
    'compose' => [
        ...
        'confirm' => [
            ...
            'description_multiple' => 'شما چند گیرنده دارید. انتخاب کنید که این ایمیل چگونه ارسال شود.',
            'send_mode_label' => 'این ایمیل چگونه ارسال شود؟',
            'send_mode_individual' => 'ارسال جداگانه هر ایمیل',
            'send_mode_individual_help' => 'برای هر گیرنده «به» یک ایمیل جداگانه ارسال می‌شود، بنابراین گیرندگان آدرس‌های یکدیگر را نمی‌بینند. مخاطبین CC/BCC نسخه‌ای از هر ایمیل را دریافت می‌کنند.',
            'send_mode_combined' => 'ارسال به صورت یک ایمیل با چند گیرنده',
            'send_mode_combined_help' => 'یک ایمیل برای همه ارسال می‌شود. تمام آدرس‌های «به» و CC برای همه گیرندگان قابل مشاهده است.',
        ],

        'notifications' => [
            'individual_sent' => 'ایمیل‌ها ارسال شدند',
            'individual_sent_body' => ':count ایمیل جداگانه ارسال شد.',
        ],
    ],
