    ...
    */
    ...
    'compose' => [
        ...
        'confirm' => [
            ...
            'description_multiple' => 'יש לך מספר נמענים. בחר כיצד ברצונך לשלוח דוא"ל זה.',
            'send_mode_label' => 'כיצד לשלוח את הדוא"ל?',
            'send_mode_individual' => 'שליחת כל דוא"ל בנפרד',
            'send_mode_individual_help' => 'דוא"ל נפרד נשלח לכל נמען בשדה "אל", כך שהנמענים אינם רואים את הכתובות זה של זה. אנשי קשר ב-CC/BCC מקבלים עותק של כל דוא"ל.',
            'send_mode_combined' => 'שליחה כדוא"ל אחד עם מספר נמענים',
            'send_mode_combined_help' => 'דוא"ל אחד נשלח לכולם. כל כתובות "אל" ו-CC גלויות לכל הנמענים.',
        ],
