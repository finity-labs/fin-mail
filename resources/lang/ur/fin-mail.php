    ...
    */
    ...
    'compose' => [
        ...
        'confirm' => [
            ...
            'description_multiple' => 'آپ کے متعدد وصول کنندگان ہیں۔ منتخب کریں کہ آپ یہ ای میل کیسے بھیجنا چاہتے ہیں۔',
            'send_mode_label' => 'یہ کیسے بھیجی جائے؟',
            'send_mode_individual' => 'ہر ای میل الگ الگ بھیجیں',
            'send_mode_individual_help' => '"بنام" کے ہر وصول کنندہ کو الگ ای میل بھیجی جاتی ہے، اس لیے وہ ایک دوسرے کے پتے نہیں دیکھ سکتے۔ CC/BCC کے تمام رابطے ہر ای میل کی نقل وصول کرتے ہیں۔',
            'send_mode_combined' => 'متعدد وصول کنندگان کے ساتھ ایک ہی ای میل بھیجیں',
            'send_mode_combined_help' => 'سب کو ایک ہی ای میل بھیجی جاتی ہے۔ "بنام" اور CC کے تمام پتے ہر وصول کنندہ کو نظر آتے ہیں۔',
        ],
